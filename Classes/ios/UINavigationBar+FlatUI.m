...
{
    [ self configureFlatNavigationBarWithColor: color preserveBarShadow: NO ];
}

- (void) configureFlatNavigationBarWithColor:(UIColor *)color preserveBarShadow:(BOOL)preserveBarShadow
{
    ...
    if ( !preserveBarShadow && [self respondsToSelector:@selector(setShadowImage:)])
    {
